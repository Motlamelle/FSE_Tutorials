...
def add_transaction(
    ...
    if transaction_type not in TRANSACTION_TYPES:
        raise ValueError(f"Invalid transactio type: {transaction_type}. Must be income or expense")
    
    if amount < 0:
        raise ValueError(f"Amount cannot be negative: {amount}. Please provide a positve value.")
